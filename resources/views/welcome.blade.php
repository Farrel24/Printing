...
<head>
    ...
    <title>GLOBAL PRINTING</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
<button class="button" data-text="Awesome">
    <span class="actual-text">&nbsp;GLOBAL&nbsp;</span>
    <span aria-hidden="true" class="hover-text">&nbsp;GLOBAL&nbsp;</span>
</button>
        <nav>
            <ul>
  ...
  <div class="wrap">
    ...
    <section class="hero">
        <div class="hero-content">
            <h1><span class="printing">PRINTING</span> <span>THE FUTURE</span></h1>
            <p>
                Pay suppliers faster, manage print jobs, and extend cash flow for longer. Get access to printing solutions without giving up equity, so that you can focus on growing your print business.            </p>
    ...
    <section class="sponsor section">
        <div class="sponsor__container container grid">
            <img src="img/sponsor1.png" alt="Sponsor 1" class="sponsor__img">
            <img src="img/sponsor2.png" alt="Sponsor 2" class="sponsor__img">
            <img src="img/sponsor3.png" alt="Sponsor 3" class="sponsor__img">
            <img src="img/sponsor4.png" alt="Sponsor 4" class="sponsor__img">
        </div>
    </section>
    ...
    <section class="hero new-section">
        <div class="hero-content">
          <h1>GOOD FOR THE PLANET. AND YOUR BUSINESS.<span></span></h1>
          <p>
            Accelerate your growth with cutting-edge technology and innovative solutions designed to streamline your business operations. Join us in transforming the future.
          </p>
          <button class="button2">
            <span class="text">Explore More </span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path
                d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"
              ></path>
            </svg>
          </button>
        </div>
        <!-- Tambahkan elemen gambar untuk dekorasi -->
        <img src="img/work.png" class="decorative-image left-image1" alt="Decorative Badge 1">
        <img src="img/work.png" class="decorative-image left-image2" alt="Decorative Badge 2">
        <img src="img/work.png" class="decorative-image right-image1" alt="Decorative Badge 3">
        <img src="img/work.png" class="decorative-image right-image2" alt="Decorative Badge 4">
        <img src="img/work.png" class="decorative-image right-image3" alt="Decorative Badge 5">
      ...
      <section class="hero-section1">
        <div class="content-wrapper1">
          ...
          <div class="text-section1">
            <div class="step-number1">01</div>
            <h1>GROW WITH THE FLOW.</h1>
            <p>We help you preserve your cash, so that you can focus on growing your business and improve cash flow.</p>
          </div>
          <!-- Right Image Section -->
          <div class="image-section1">
            <img src="img/gambar.jpg" alt="Cash Flow Chart" />
          </div>
        </div>
      </section>
      ...
      <section class="hero-section1">
        <div class="content-wrapper1">
          ...
          <div class="image-section2">
            <img src="img/lobe.jpg" alt="Cash Flow Chart" />
          </div>
          <!-- Left Text Section -->
          <div class="text-section2">
            <div class="step-number1">02</div>
            <h1>GROW WITH THE FLOW.</h1>
            <p>We help you preserve your cash, so that you can focus on growing your business and improve cash flow.</p>
          </div>
        </div>
      ...
      <section class="hero-section1">
        <div class="content-wrapper1">
          ...
          <!-- Left Text Section -->
          <div class="text-section25">
            <div class="step-number1">05</div>
